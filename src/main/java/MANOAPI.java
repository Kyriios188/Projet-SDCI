...
class MANOAPI {
    ...
    void deploy_monitoring_vnf() {
        String command = "curl -s -X PUT http://127.0.0.1:5001/restapi/compute/dc1/monitor -H 'Content-Type: application/json' -d '{\"image\":\"vnf:latest\", \"network\":\"(id=vnf-eth0,ip=10.0.0.20/24)\"}'";
        try {
