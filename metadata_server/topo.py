...
def create_topology():
    ...
    gwf1 = net.addDocker('gwf1', dimage='node_test', mem_limit="512m", environment={'CONTAINER_TYPE': 'gwf1'})
    gwf2 = net.addDocker('gwf2', dimage='node_test', mem_limit="512m", environment={'CONTAINER_TYPE': 'gwf2'})
    gwf3 = net.addDocker('gwf3', dimage='node_test', mem_limit="512m", environment={'CONTAINER_TYPE': 'gwf3'})
    dev1 = net.addDocker('dev1', dimage='node_test', mem_limit="512m", environment={'CONTAINER_TYPE': 'dev1'})
    dev2 = net.addDocker('dev2', dimage='node_test', mem_limit="512m", environment={'CONTAINER_TYPE': 'dev2'})
    dev3 = net.addDocker('dev3', dimage='node_test', mem_limit="512m", environment={'CONTAINER_TYPE': 'dev3'})
